...
export default function StartPage() {
    ...
    return (
        <Wrapper>
            <img style={{marginTop:'160px', opacity: 0}} src={Logo} alt="Logo Icon" className="icon" />
            <Main className="Main">
                AL-Go
                <Main_2 className="Main2">
                 Alert Global
                </Main_2>
            </Main>
            <Main_3 className="Main3">
                세계인을 위한 재난문자 안내 서비스
            </Main_3>

            <StartButtonStyle onClick={goLogin}>
               로그인 (Signin)
            </StartButtonStyle>
            <StartButtonStyle onClick={goRegister} style={{backgroundColor:'#F9FAFF', color:"#8DA6BB", marginTop : '20px'}}>
                회원가입 (SignUp)
            </StartButtonStyle>
        </Wrapper>
    );
