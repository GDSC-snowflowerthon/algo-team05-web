...
export default function RegisterPage() {
  ...
  return (
    <Wrapper>
      ...
      <Lttext
        style={{ marginTop: "60px", display: "flex", alignItems: "left" }}
      >
        이메일(email)
      </Lttext>
      <InputStyled
      ...
      <Lttext style={{ marginTop: "30px" }}>언어 선택(language)</Lttext>
      ...
      <ButtonStyle top="50px" onClick={handleSignUp}>
        가입(SignUp)
      </ButtonStyle>
    </Wrapper>
  );
